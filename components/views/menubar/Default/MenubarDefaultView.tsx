...
import './menubar-default.scss'
import { AVContainer, AVButton, AVLink } from '~/components/controls'
import { LightBrandLogo } from '~/static/img'
...
export const MenubarDefaultView = () => {
  ...
  return (
    <div class="av-view-menubar-default">
      <AVContainer sizingType="TKPDA">
        ...
        <div class="enclosing-menubar">
          ...
          <div class="enclosure-brand">
            <AVLink link="/">
              <img src={LightBrandLogo} alt="Brand" />
            </AVLink>
          </div>
